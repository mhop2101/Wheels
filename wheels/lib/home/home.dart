    ...
    return Scaffold(
      ...
      body: FirebaseAnimatedList(
        ...
        itemBuilder: (
          ...
          Future<dynamic> show = _preferenceService.getSubsciptionStatus(
              snapshot.value["Grupo"].split(" ").join("_"));
          return buildPostCard(context, index, snapshot, show);
        },
      ),
      /*
      ListView.builder(
...
Widget buildPostCard(context, index, trips, show) {
